...
// DOM nodes selected by css selector method
...
// DOM nodes selected by getElementsById method
...
const expHeader = '<h2 class="title2">Experience</h2>';
const skillsHeader = '<h2 class="title2">Technical Skills</h2>';
const projHeader = '<h2 class="title2">Projects</h2>';
const internHeader = '<h2 class="title2">InternShips</h2>';
const achieveHeader = '<h2 class="title2">Achievements</h2>';
...
// function to render list of eduction element
...
// function to render education element
...
// function to get percentage of level
...
// function to render skills element
...
// function to render hobbies element
...
// function to render experience element
...
// Main function that renders the page with all the elements
...
// function to run and display the next resume data in the weppage
...
// calling main function to initialize the page
runApplication(id, await getData());